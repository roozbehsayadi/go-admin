...
var fa = LangSet{
	...
	"updatedat":        "آپدیت شده در",
	"path":             "مسیر",
	"new":              "جدید",
	"filter":           "فیلتر",
	"action":           "اکشن",
	"toggle dropdown":  "باز/بسته کردن منوی بازشونده",
	"delete":           "حذف",
	"refresh":          "ریفرش",
	"expand":           "گسترش",
	"collapse":         "بستن",
	...
	"sign out":         "خروج",
	"all":              "همه",
	"confirm password": "تأییدِ رمز",
	"search":           "جست‌وجو",
	"remove":           "پاک کردن",

	"goadmin is now running. \nrunning in \"debug\" mode. switch to \"release\" mode in production.\n\n": "گو-ادمین در حال اجرا است. \nدر حال اجرا در حالت «دیباگ». در پروداکشن به حالت «انتشار» تغییر دهید",

	"wrong goadmin version, theme %s required goadmin version are %s": "ورژن گو-ادمین اشتباه است، قالبِ %s به گو-ادمین ورژن %s یا بالاتر احتیاج دارد",

	"wrong theme version, goadmin %s required version of theme %s is %s": "ورژن قالب استفاده‌شده اشتباه است، گو-ادمین %s به قالب %s با ورژن %s احتیاج دارد",

	"adapter is nil, import the default adapter or use addadapter method add the adapter": "آداپتور مقداردهی نشده است، آداپتور پیش‌فرض را ایمپورت کرده و یا از تابع AddAdapter استفاده کنید تا آداپتور اضافه شود",

	"are you sure to delete":               "آیا از حذف مطمئن هستید",
	"yes":                                  "بله",
	"got it":                               "متوجه شدم",
	"cancel":                               "لغو",
	"refresh succeeded":                    "ریفرش موفقیت‌آمیز بود",
	"reload succeeded":                     "ریلود موفقیت‌آمیز بود",
	"all method if empty":                  "همه‌ی متدها در صورت خالی بودن",
	"password does not match":              "رمزها یکی نیستند",
	"should be unique":                     "باید یکتا باشد",
	"slug exists":                          "این اسلاگ وجود دارد",
	"no corresponding options?":            "هیچ آپشن مرتبطی وجود ندارد؟",
	"create here.":                         "این‌جا ایجاد کنید.",
	"use for login":                        "برای لاگین استفاده شود",
	"use to display":                       "برای نشان دادن استفاده شود",
	"a path a line, without global prefix": "هر مسیر در یک خط",
	"slug or http_path or name should not be empty": "اسلاگ یا مسیر اچ‌تی‌تی‌پی یا اسم نباید خالی باشد",
	"no roles":          "بدون نقش",
	"fixed the sidebar": "نوار کناری ثابت شود",
	"enter fullscreen":  "حالت تمام‌صفحه",
	"exit fullscreen":   "خروجی از حالت تمام‌صفحه",

	"permission manage": "مدیریت اجازه‌ها",
	"menus manage":      "مدیریت منوها",
	"roles manage":      "مدیریت نقش‌ها",
	"operation log":     "لاگِ عملیات",

	"continue editing":  "ادامه دادن ادیت",
	"continue creating": "ادامه دادن ساختن",
	...
	"initialize configuration":        "مقداردهی اولیه‌ی تنظیمات",
	"initialize navigation buttons":   "مقداردهی اولیه‌ی دکمه‌های جهت‌یابی ",
	"initialize plugins":              "مقداردهیِ اولیه‌ی پلاگین‌ها",
	"initialize database connections": "مقداردهی اولیه‌ی اتصال‌های دیتابیس",
	"initialize success":              "مقداردهی اولیه با موفقیت انجام شد ☕️☕️",

	"not found":      "پیدا نشد",
	"internal error": "ارور داخلی",
	"unauthorized":   "احراز هویت نشده",
	"plugin setting": "تنظیمات پلاگین",

	"plugins":          "پلاگین‌ها",
	"plugin store":     "مغازه‌ی پلاگین‌فروشی",
	"get more plugins": "گرفتن پلاگین‌های بیشتر",
	"uninstalled":      "پاک شد",
